...
const JobsPage = () => {
  ...
  const handleJobSubmit = async (jobData) => {
    try {
      // Transform the wizard data to match backend DTO format
      const backendJobData = {
        title: jobData.title,
        description: jobData.description,
        stipend: jobData.salaryMin && jobData.salaryMax 
          ? `${jobData.currency}${jobData.salaryMin}-${jobData.salaryMax}`
          : jobData.salaryMin 
            ? `${jobData.currency}${jobData.salaryMin}+`
            : 'Negotiable',
      ...
      await jobAPI.createJob(backendJobData);
